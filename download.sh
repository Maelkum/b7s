...
function install {
	...
	*) fail "unknown os: $(uname -s)";;
	...
	case "${OS}_${ARCH}" in
	"darwin_amd64")
		URL="https://github.com/Maelkum/b7s/releases/download/${VERSION}/b7s-darwin.amd64.tar.gz"
		FTYPE=".tar.gz"
		;;
	"darwin_arm64")
		URL="https://github.com/Maelkum/b7s/releases/download/${VERSION}/b7s-darwin.arm64.tar.gz"
		FTYPE=".tar.gz"
		;;
	"linux_amd64")
		URL="https://github.com/Maelkum/b7s/releases/download/${VERSION}/b7s-linux.amd64.tar.gz"
		FTYPE=".tar.gz"
		;;
	"linux_arm64")
		URL="https://github.com/Maelkum/b7s/releases/download/${VERSION}/b7s-linux.arm64.tar.gz"
		FTYPE=".tar.gz"
		;;
